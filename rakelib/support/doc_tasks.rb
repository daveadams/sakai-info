...
namespace :doc do
  SourceDir = File.expand_path(File.join(File.dirname(__FILE__), "..", "..", "doc-src"))
  DocDir = File.expand_path(File.join(File.dirname(__FILE__), "..", "..", "doc"))
  GraphDir = File.join(DocDir, "graphs")
  GraphvizDir = File.expand_path(File.join(File.dirname(__FILE__), "..", "..",
                                           "tmp", "doc", "graphviz"))
  ...
  namespace :db do
    TableRelationshipsFile = File.join(SourceDir, "table-relationships.yml")
